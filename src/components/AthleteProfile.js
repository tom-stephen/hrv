...
const mockAthletes = {
  1: { name: 'John Smith', readiness: 'green', lastHRV: 52 },
  2: { name: 'Sarah Johnson', readiness: 'yellow', lastHRV: 38 },
  3: { name: 'Mike Davis', readiness: 'red', lastHRV: 35 },
  4: { name: 'Emma Wilson', readiness: 'green', lastHRV: 48 },
  5: { name: 'Alex Brown', readiness: 'yellow', lastHRV: 41 },
};
...
const AthleteProfile = () => {
  ...
  const athlete = mockAthletes[id] || { name: 'Unknown Athlete', readiness: 'green', lastHRV: 0 };
    ...
    <Container maxWidth="md" sx={{ py: 2 }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          <IconButton onClick={() => navigate('/coach')} sx={{ mr: 2 }}>
            <ArrowBack />
          </IconButton>
